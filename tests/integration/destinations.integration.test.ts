// Ensure env set before importing anything that may create a pool
...
async function ensureDbAndMigrations() {
  // if container is not running, bring it up (and apply migrations)
  ...
  // apply migrations (idempotent for tests)
